...
//var bookpicturepath='C:/Users/asus/Desktop/VueJsBookShopLab-master/src/assets/bookImages/';
...
app.get(apiversion + '/student/:studentId',verify, function (req, res)  {  
  ...
  try
  {
    ...
    db.query('SELECT * FROM students where studentId=?', studentId.toString(),function (error, results, fields) {
        if (error) throw error;
